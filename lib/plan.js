...
export function buildPlan({ route, entries, installed = {}, options = {} }) {
  ...
  if (entries.length === 0) {
    return { route, mode: 'none', reason: 'pi.dev lists no models for this route', routeModels: [], companionModels: [], dropped, warnings, builtinCount: installedIds.size, noveltyCount: 0 };
  }
